const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover">blood</a>
  ...
  <nav>
    ...
    <a className="link link-hover">bloodDonate</a>
    <a className="link link-hover">Willing Doner</a>
  </nav> 
  <nav>
  ...
  <form>
    ...
    <fieldset className="form-control hidden md:block md:w-80">
